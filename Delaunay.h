...
public:
	...
	vertex(const vertex& v)		: m_Pnt(v.m_Pnt), m_userData(v.m_userData)	{}
    ...
    void SetUserData(int val)       { m_userData = val; }
...
public:
	...
	void Triangulate(const vertexSet& vertices, triangleSet& output) const;
